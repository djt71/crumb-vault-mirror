...
### vault-optimization — software / system / four-phase  *(DONE 2026-08-10)*
- **Phase:** DONE (operator decision 2026-08-10) · **updated:** 2026-08-10
- **Status:** COMPLETE — all 28 tasks (VO-010–037). M4 destructive batches B0–B6 executed 2026-07-03/04; M5 soak PASS (closed 2026-08-08; zero restores incl. 25-day unattended stretch; Tier-1 #1–#3 unexercised → opportunistic watch items, no gate). **VO-036 closed 2026-08-10** (validation-record.md written, crumb-operating-note.md FINAL, 6-deliverable completion contract verified, operator sign-off). **VO-037 executed same day:** CLAUDE.md 220→167 lines (~22% always-loaded token cut; 9 operator-approved edits, rare-fire sections pointerized, duplicated facts single-sourced) + spec v2.5 structural reorg (§3.1/§3.3 → as-built 11-skill registry) + **spec renamed version-neutral: `crumb-design-spec.md`** (was crumb-design-spec-v2-4.md; 20 referencing files updated).
- **Next:** nothing open. Archival operator-initiated when desired (KB-exception candidates: keep-set-manifest, validation-record).
