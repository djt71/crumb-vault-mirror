...
|----|-------------|-------|------------|------------|--------|---------------------|
| VO-010 | [VO-001] Refresh + accept v3 identity ADR: review Tier 1/2/3 vs post-sunset reality, answer its open operator questions, status → accepted; record proceed/re-plan gate outcome | pending | — | medium | software | ADR frontmatter `status: accepted`? All 5 acceptance boxes checked? All open questions recorded in the ADR answered? Gate outcome + operator sign-off in run-log? |
