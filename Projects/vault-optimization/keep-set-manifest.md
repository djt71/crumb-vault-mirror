...
| dns-recon.sh | script | ~~no-evidence~~ → **proven-active (structural)** — RECLASSIFIED at VO-019 | **evidence-status change (A2):** `Projects/customer-intelligence/import-workflow.md` (project phase ACT) invokes it at :126 and requires its output `dns-recon.md` at :115/:159/:205/:211 — VO-013 pass missed project-doc surfaces | prop: **keep** (was prop: delete) — A2 operator re-review required; prior wholesale sign-off voided for this row | VO (B4) | **RETURNED TO OPERATOR 2026-06-10 (A2)** — was approved+signed wholesale; new evidence postdates signature |
