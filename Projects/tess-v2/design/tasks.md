...
| TV2-043 | Migrate Opportunity Scout pipeline | todo | TV2-034, TV2-035 | medium | code | All 3 Scout services (daily-pipeline, feedback-poller, weekly-heartbeat) on new platform. Parallel run 72h. Daily digest delivery at correct time. Feedback commands functional. Scoring parity ≥90% on sampled items. Rollback tested. |
