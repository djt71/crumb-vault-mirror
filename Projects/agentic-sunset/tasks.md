...
| AS-027 | Gitignore toolchain-written churn files; verify working tree reaches clean after one full scheduler cycle | in-progress | AS-026 | low | software | `git status` clean ≥1 scheduler cycle after commit: PARTIAL ✓ 2026-06-12 — 5 churn files (vault-gc.log, vault-backup-last.json, ops-metrics.jsonl, vault-health.{log,notes-md}) gitignored + untracked; stale `_openclaw/*` ignore block retired; clean-tree verification after tonight's 2/3/4/5 AM cycle → 2026-06-13 |
